local Translations = {
    error = {
        ...
        in_vehicle = "Can't solicit while NOT in a vehicle",
    ...
    info = {
		offer = "[E] $%{trickprice} for %{tricktime} minutes [Z] decline offer",
        started_solicitation = "You started solicitation",
        stopped_solicitation = "You stopped solicitation",
        has_been_robbed = "You have been robbed and lost $%{money} money",
        ...
        what_now = "What do you want to do now? Acceptable inputs: [E] [Y] [U]",
        ...
        selling_to_ped = "Comfirming Deal...",
