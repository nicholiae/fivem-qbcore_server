...
CreateThread(function()
	local blip = AddBlipForCoord(Shared.BlipLocations.boxZone.x, Shared.BlipLocations.boxZone.y, Shared.BlipLocations.boxZone.z)
	...
	local blip2 = AddBlipForCoord(Shared.BlipLocations.polyZone.x, Shared.BlipLocations.polyZone.y, Shared.BlipLocations.polyZone.z)
	SetBlipSprite (blip2, 762)
...
CreateThread(function()
    ...
    fishingCombo:onPlayerInOut(function(isPointInside, point, zone)
        if isPointInside then
            exports['qb-core']:DrawText('Fishing', 'Right')
            canFish = true
        else
