...
Shared.MinigameCirclesMax = 5 -- Minigame: Maximum amount of circles
Shared.MinigameTime = 20 -- Minigame: Amount of time in seconds

Shared.SellLocation = vector4(1348.36, 4317.34, 37.04, 83.71)
Shared.BlipLocations = {
	boxZone = vector3(713.31, 4113.7, 35.78),
	polyZone = vector3(-329.42422485352, 4385.888671875, 55.0)
}
Shared.FishingZones = {
    ...
    [3] = { -- coastal fishing
        points = {
            vector2(-4081.76, -5049.57),
			vector2(4812.12, -5052.45),
			vector2(4824.58, 8355.55),
			vector2(-4124.37, 8375.45)
