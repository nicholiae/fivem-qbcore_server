local Translations = {
    ...
    info = {
        started_selling_drugs = "You started looking for unaware people",
        stopped_selling_drugs = "You stopped looking for unaware people",
        has_been_robbed = "You have been robbed and lost %{money}",
        suspicious_situation = "Suspicious situation",
        possible_drug_dealing = "Possible drug dealing",
        trick_offer = "[E] Donate %{trickTime} for $%{trickPrice}? / [G] Decline offer",
        target_trick_offer = " %{trickTime} RaiseAwareness for $%{trickPrice}?",
        ...
        selling_to_ped = "Performing a Trick...",
