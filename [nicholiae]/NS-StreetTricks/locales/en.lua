local Translations = {
    ...
    info = {
        started_selling_drugs = "You started looking for a Trick",
        stopped_selling_drugs = "You stopped looking for a Trick",
        ...
        trick_offer = "[E] Sexy %{trickTime} for $%{trickPrice}? / [G] Decline offer",
        target_trick_offer = "Sell sexy %{trickTime} for $%{trickPrice}?",
