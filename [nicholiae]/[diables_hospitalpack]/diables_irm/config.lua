...
Config.TargetLabelStop = 'Stop l\'IRM'
Config.TargetLabelStart = 'Start l\'IRM'
...
Config.KeyTextLeaveTable = 'Leave Table l\'irm' -- Key text visible in FiveM keys

Config.ClientEvent = 'diables_irm:client:move' -- Set the client event name -- exemple 'diables_irm:client:move'
Config.ServerEvent = 'diables_irm:server:move' -- Set the server event name -- exemple ''diables_irm:server:move'
