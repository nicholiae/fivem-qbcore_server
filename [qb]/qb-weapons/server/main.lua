...
QBCore.Functions.CreateCallback('qb-weapons:server:RepairWeapon', function(source, cb, RepairPoint, data)
    ...
    local Timeout = math.random(4 * minute, 6 * minute)
...
local AmmoTypes = {
    ...
    paintball_ammo = { ammoType = 'AMMO_PAINTBALL', amount = 100 },
    rpg_ammo = { ammoType = 'AMMO_RPG', amount = 5 },
    mini_ammo = { ammoType = 'AMMO_MINIGUN', amount = 999 },
    grenade_ammo = { ammoType = 'AMMO_GRENADELAUNCHER', amount = 3 },
    sniper_ammo = { ammoType = 'AMMO_SNIPER', amount = 5 }
}
