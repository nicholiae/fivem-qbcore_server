local Translations = {
    ...
    info = {
        received_paycheck = 'You received your paycheck of $%{value} and paid taxes worth: $%{value2}',
        taxes_paid = 'You have paid a total of: $%{value} in taxes this cycle',
        received_unemployement = 'You received unemployement pay totaling: $%{value}',
