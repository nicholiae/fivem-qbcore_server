QBShared.Locations = {
	...
	battleroyal = vector4(-1733.27, -2772.07, 13.94, 292.7),
	school = vector4(-1581.61, 207.22, 60.74, 282.42),
	home = vector4(-766.07, 320.02, 217.05, 89.71),
	mayor = vector4(-533.39, -191.53, 47.74, 308.16),
	druglab_one = vector4(2440.18, 4969.84, 46.83, 238.18),
	druglab_two = vector4(1393.27, 3603.22, 38.94, 300.48),
	druglab_three = vector4(242.6, 364.06, 105.74, 355.3),
	bm1 = vector4(-588.94, -1619.07, 33.01, 86.75),
	bm2 = vector4(-877.01, -2301.85, -11.73, 154.98),
	bm3 = vector4(-440.23, -1678.02, 19.29, 349.37),
	bm4 = vector4(336.53, -1688.61, 27.31, 288.95),
	bm5 = vector4(232.6, -1360.39, 28.65, 127.78),
	bm6 = vector4(-62.01, -1218.13, 28.7, 278.26), --happy homeless town
	bm7 = vector4(-1670.01, -1002.19, 7.38, 97.48), --beachside
	bm8 = vector4(-1972.48, -286.78, 48.11, 317.01), --7007 parking garage top floor
	bm9 = vector4(-169.9, 491.29, 130.04, 272.03), --6095 interior TP rqrd
	bm10 = vector4(1487.81, 1128.66, 114.34, 1.23), -- La Fuenta Farmhouse
    ...
    counterfeit_cash_int = vector4(1138.2513, -3198.7056, -39.6657, 66.1039), -- money wash
    document_forgery_int = vector4(1173.4496, -3196.7759, -39.008, 77.9179),
    doomsday_facility_int = vector4(453.0641, 4820.2095, -58.9997, 87.7778), --- used in sub heist ?
    ...
    shell_1_int = vector4(404.9589, -957.7651, -99.0042, 1.7754), --can fall out of 
    submarine_int = vector4(512.8119, 4881.4795, -62.5867, 359.146),
    uniondepository_int = vector4(5.8001, -708.6383, 16.131, 348.7656), -- heist Bank vault room
