...
AddEventHandler('playerDropped', function(reason)
    ...
    -- TriggerEvent("qb-log:server:CreateLog", "joinleave", "Dropped", "red", "**".. GetPlayerName(src) .. "** (<@"..(QBCore.Functions.GetIdentifier(src, 'discord'):gsub("discord:", "") or "unknown").."> |  ||"  ..(QBCore.Functions.GetIdentifier(src, 'ip') or 'undefined') ..  "|| | " ..(QBCore.Functions.GetIdentifier(src, 'license') or 'undefined') .." | " ..Player.PlayerData.citizenid.." | "..src..") left..")
...
local function onPlayerConnecting(name, _, deferrals)
	...
	-- TriggerEvent("qb-log:server:CreateLog", "joinleave", "Connecting", "yellow", "(<@"..(QBCore.Functions.GetIdentifier(src, 'discord'):gsub("discord:", "") or "unknown").."> |  ||"  ..(QBCore.Functions.GetIdentifier(src, 'ip') or 'undefined') ..  "|| | " ..(QBCore.Functions.GetIdentifier(src, 'license') or 'undefined') .." | "..(src or 'unknown')..") connecting..")
...
RegisterNetEvent('QBCore:UpdatePlayerBiology', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    if not Player then return end
    local newHygiene = Player.PlayerData.metadata['hygiene'] - QBCore.Config.Player.HygieneRate
    local newBioOne = Player.PlayerData.metadata['bioone'] - QBCore.Config.Player.BioOneRate
    local newBioTwo = Player.PlayerData.metadata['biotwo'] - QBCore.Config.Player.BioTwoRate
    ...
    TriggerClientEvent('hud:client:UpdateNeedsBiology', src, newHygiene, newBioOne, newBioTwo)
    Player.Functions.Save()
end)
