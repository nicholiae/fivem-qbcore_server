...
const load = Vue.createApp({
  setup () {
    return {
      CarouselText1: 'Gangs are intermixed with NPC Gangs in city. Join a gang find out how it works.',
      CarouselSubText1: 'Captured by StarValley Staff',
      CarouselText2: 'Have some ideas to make this city awesomer? Join the discord we love ideas!',
      CarouselSubText2: 'Photo captured by: StarValley Staff',
      CarouselText3: 'Everything you find in this city has been hand crafted or adjusted by StarValley Staff.',
      CarouselSubText3: 'Photo captured by: StarValley Staff',
      CarouselText4: 'For additional support please join our community at discord.gg/VTBxU2X5du',
      CarouselSubText4: 'Photo captured by: StarValley Staff',

      DownloadTitle: 'Downloading StarValley RP Server',
      DownloadDesc: "Hold tight while we begin downloading all the resources/assets required to play on StarValley RP. \n\nAfter download has been finished successfully, you'll be placed into the server and this screen will disappear. Please don't leave or turn off your PC. ",
