...
Config.MenuItems = {
    {
        ...
        items = {
			...
			id = 'corner collection',
			title = 'Corner Collection',
			icon = 'plus',
			items = { 
				{
					id = 'cornerselling',
					...
					icon = 'street-view',
					type = 'client',
					event = 'NS-StreetTricks:client:trickselling',
					shouldClose = true
				} , {
					id = 'solicitation',
					title = 'Solicitation',
					icon = 'street-view',
					type = 'client',
					event = 'NS-PickUp:client:Solicitation',
					shouldClose = true
				} 
			}
		},{
			...
			icon = 'plus',
			type = 'client',
			event = 'NS-Crafting:client:craftingTableCall',
			shouldClose = true
		},{
            id = 'togglehotdogsell',
