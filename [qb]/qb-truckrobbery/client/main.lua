...
local function PoliceCall()
	...
	local level = 5
	local message = "You are now Most-Wanted!"
...
-- CreateThread(function()
	...
	-- AddTextComponentSubstringPlayerName('TruckHeist')
...
CreateThread(function()
	...
	while playerDeathCheck == true do
		...
		if IsPedDeadOrDying(player) == 1 then
			...
			exports['qb-inventory']:RemoveItem(player, 'markedbills', bags, false, 'qb-truckrobbery:playerDeath')
			TriggerEvent('qb-inventory:client:ItemBox', player, QBCore.Shared.Items['markedbills'], 'remove')
	...
	CreateThread(function()
		...
		while not spawned do
			...
			if distance < 200 then
				...
				pilot = CreatePed(26, "s_m_m_security_01", VehicleCoords.x+5, VehicleCoords.y, VehicleCoords.z, 268.9422, true, false)
				navigator = CreatePed(26, "s_m_m_security_01", VehicleCoords.x, VehicleCoords.y+5, VehicleCoords.z, 268.9422, true, false)
				navigator2 = CreatePed(26, "s_m_m_security_01", VehicleCoords.x+5, VehicleCoords.y+5, VehicleCoords.z, 268.9422, true, false)
