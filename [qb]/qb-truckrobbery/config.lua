...
Config.MissionMarker =  vector3(306.75, -225.23, 61.58)  -- place where is the marker with the mission
Config.DealerCoords = vector3(306.75, -225.23, 61.58) -- place where the NPC dealer stands
...
Config.Currency = "$"
Config.ResetTimer = 1200 -- cooldown for mission in seconds