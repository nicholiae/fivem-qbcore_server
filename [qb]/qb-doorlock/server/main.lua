...
QBCore.Commands.Add('newdoorreal', Lang:t("general.newdoor_command_description"), {}, false, function(source)
	local Player = QBCore.Functions.GetPlayer(source)
	if Player.PlayerData.job.name == 'realestate' then
		TriggerClientEvent('qb-doorlock:client:addNewDoor', source)
	else
		TriggerClientEvent('QBCore:Notify', source, "You are not entitled to use this command", 'error')
	end
end)
