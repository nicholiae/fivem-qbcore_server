...
-- Real Estate Office Location (where agents trigger the preview)
Config.RealEstateOffice = {
    coords = vector3(-708.61, 271.93, 83.15), -- Dynasty 8 Real Estate Office
    heading = 210.0,
...
-- Real Estate Preview/Showroom Location (where interiors spawn)
Config.PreviewLocation = {
    coords = vector3(-757.32, 254.39, 917.88), -- Change to your desired location
    heading = 0.0,
}

-- Interior Types with Names and Prices
Config.InteriorTypes = {
    { tier = 1,  name = 'Apartment Shell',        price = 50000,  description = 'Basic apartment layout' },
    { tier = 2,  name = 'Tier 1 House',           price = 75000,  description = 'Small starter home' },
    { tier = 3,  name = 'Trevors Shell',          price = 85000,  description = 'Trailer-style home' },
    { tier = 4,  name = 'Caravan Shell',          price = 60000,  description = 'Mobile home interior' },
    { tier = 5,  name = 'Lester Shell',           price = 95000,  description = 'Modern apartment' },
    { tier = 6,  name = 'Ranch Shell',            price = 150000, description = 'Spacious ranch house' },
    { tier = 7,  name = 'Container',              price = 45000,  description = 'Container home' },
    { tier = 8,  name = 'Furnished Mid',          price = 120000, description = 'Mid-tier furnished' },
    { tier = 9,  name = 'Motel Modern',           price = 80000,  description = 'Modern motel room' },
    { tier = 10, name = 'Franklin Aunt',          price = 110000, description = 'Family home' },
    { tier = 11, name = 'Garage Medium',          price = 90000,  description = 'Home with garage' },
    { tier = 12, name = 'Michael House',          price = 200000, description = 'Luxury home' },
    { tier = 13, name = 'Office 1',               price = 130000, description = 'Office space' },
    { tier = 14, name = 'Store 1',                price = 100000, description = 'Retail space' },
    { tier = 15, name = 'Warehouse 1',            price = 180000, description = 'Large warehouse' },
    { tier = 16, name = 'Motel Standard',         price = 70000,  description = 'Standard motel room' },
    { tier = 17, name = 'Modern Villa 1 (Unfurnished)', price = 250000, description = 'Modern villa u' },
    { tier = 18, name = 'Modern Villa 1 (Furnished)',  price = 300000, description = 'Modern villa f' },
    { tier = 19, name = 'Modern Villa 2 (Unfurnished)', price = 275000, description = 'Modern villa 2 u' },
    { tier = 20, name = 'Modern Villa 2 (Furnished)',  price = 350000, description = 'Modern villa 2 f' },
}

Config.MinZOffset = -800
Config.RamsNeeded = 2
Config.UnownedBlips = false
Config.HouseRelinquish = 35
Config.Houses = {}
Config.Targets = {}
