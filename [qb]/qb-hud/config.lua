...
Config.MinimumSpeedUnbuckled = 60 -- Going Over This Speed Unbuckled Will Cause Stress
...
Config.Menu = {
    ...
    isDynamicHygieneChecked = true,      -- isDynamicHygieneChecked
    isDynamicBioOneChecked = true,      -- isDynamicBioOneChecked
    isDynamicBioTwoChecked = true,      -- isDynamicBioTwoChecked
