...
const app = Vue.createApp({
    data: function () {
        return {
            ...
            isDynamicHygieneChecked: this.initIsDynamicHygieneChecked(),
            isDynamicBioOneChecked: this.initIsDynamicBioOneChecked(),
            isDynamicBioTwoChecked: this.initIsDynamicBioTwoChecked(),
    ...
    watch: {
        ...
        isDynamicHygieneChecked: function () {
            localStorage.setItem("isDynamicHygieneChecked", this.isDynamicHygieneChecked);
        },
        isDynamicBioOneChecked: function () {
            localStorage.setItem("isDynamicBioOneChecked", this.isDynamicBioOneChecked);
        },
        isDynamicBioTwoChecked: function () {
            localStorage.setItem("isDynamicBioTwoChecked", this.isDynamicBioTwoChecked);
        },
    ...
    methods: {
        ...
        initIsDynamicHygieneChecked: function () {
            const stored = localStorage.getItem("isDynamicHygieneChecked");
            if (stored === null) {
                return false;
            } else {
                return stored == "true";
        ...
        initIsDynamicBioOneChecked: function () {
            const stored = localStorage.getItem("isDynamicBioOneChecked");
            if (stored === null) {
                return false;
            } else {
                return stored == "true";
        ...
        initIsDynamicBioTwoChecked: function () {
            const stored = localStorage.getItem("isDynamicBioTwoChecked");
            if (stored === null) {
                return false;
            } else {
                return stored == "true";
        ...
        dynamicHygiene: function (event) {
            targetId = event.currentTarget.id;
            dynamicHygiene();
        },
        dynamicBioOne: function (event) {
            targetId = event.currentTarget.id;
            dynamicBioOne();
        },
        dynamicBioTwo: function (event) {
            targetId = event.currentTarget.id;
            dynamicBioTwo();
        },
...
function dynamicHygiene() {
    $.post("https://qb-hud/dynamicHygiene");
}
function dynamicBioOne() {
    $.post("https://qb-hud/dynamicBioOne");
}
function dynamicBioTwo() {
    $.post("https://qb-hud/dynamicBioTwo");
}
...
const moneyHud = Vue.createApp({
    ...
    methods: {
        ...
        showConstant(data) {
            this.showCash = true;
            this.showBank = true;
            this.showStarBucks = true;
            this.cash = data.cash;
            this.bank = data.bank;
            this.starbucks = data.starbucks;
        },
        update(data) {
            ...
            if (data.type === "starbucks") {
                if (data.minus) {
                    this.showStarBucks = true;
                    this.minus = true;
                    setTimeout(() => (this.showUpdate = false), 1000);
                    setTimeout(() => (this.showStarBucks = false), 2000);
                } else {
                    this.showStarBucks = true;
                    this.plus = true;
                    setTimeout(() => (this.showUpdate = false), 1000);
        ...
        showAccounts(data) {
			...
			else if (data.type === "starbucks" && !this.showStarBucks) {
                this.showStarBucks = true;
                this.starbucks = data.starbucks;
                setTimeout(() => (this.showStarBucks = false), 3500);
            } 
...
const playerHud = {
    ...
    methods: {
        hudTick(data) {
            ...
            this.dynamicHygiene = data.dynamicHygiene;
            this.dynamicBioOne = data.dynamicBioOne;
            this.dynamicBioTwo = data.dynamicBioTwo;
            ...
            if (data.dynamicHygiene == true) {
                if (data.hygiene >= 100) {
                    this.showHygiene = false;
                } else {
                    this.showHygiene = true;
                }
            } else if (data.dynamicHygiene == false) {
                this.showHygiene = true;
            }
			
            if (data.dynamicBioOne == true) {
                if (data.bioone >= 100) {
                    this.showBioOne = false;
                } else {
                    this.showBioOne = true;
                }
            } else if (data.dynamicBioOne == false) {
                this.showBioOne = true;
            }
			
            if (data.dynamicBioTwo == true) {
                if (data.biotwo >= 100) {
                    this.showBioTwo = false;
                } else {
                    this.showBioTwo = true;
                }
            } else if (data.dynamicBioTwo == false) {
                this.showBioTwo = true;
            }
