...
local function GiveStarterItems(source)
    ...
    for _, v in pairs(QBCore.Shared.StarterItems) do
        ...
        exports['qb-inventory']:AddItem(src, v.item, v.amount, nil, info, 'qb-multicharacter:GiveStarterItems')
    end
    TriggerEvent("qb-log:server:CreateLog", "joinleave", "StarterItems", "blue", "**".. GetPlayerName(src) .. "** (<@"..(QBCore.Functions.GetIdentifier(src, 'discord'):gsub("discord:", "") or "unknown").."> |  ||"  ..(QBCore.Functions.GetIdentifier(src, 'ip') or 'undefined') ..  "|| | " ..(QBCore.Functions.GetIdentifier(src, 'license') or 'undefined') .." | "..src..") loaded..")
...
RegisterNetEvent('qb-multicharacter:server:createCharacter', function(data)
    local src = source
    TriggerEvent("qb-log:server:CreateLog", "joinleave", "CreatingCharacter", "yellow", "**".. GetPlayerName(src) .. "** (<@"..(QBCore.Functions.GetIdentifier(src, 'discord'):gsub("discord:", "") or "unknown").."> |  ||"  ..(QBCore.Functions.GetIdentifier(src, 'ip') or 'undefined') ..  "|| | " ..(QBCore.Functions.GetIdentifier(src, 'license') or 'undefined') .." | " ..data.cid.." | "..src..") loaded..")
    local newData = {}
