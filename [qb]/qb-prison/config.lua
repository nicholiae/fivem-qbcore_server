...
Config.Uniforms = {
    ['male'] = {
        outfitData = {
            ...
            ['torso2'] = { item = 413, texture = 9 },
            ['arms'] = { item = 15, texture = 0 },
            ['pants'] = { item = 210, texture = 0 },
...
Config.Locations = {
    freedom = vector4(1759.72, 2528.79, 45.56, 43.08),
    outside = vector4(1848.13, 2586.05, 44.67, 269.5),
    yard = vector4(1761.49, 2490.02, 45.84, 120.93),
