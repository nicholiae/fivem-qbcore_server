...
RegisterNetEvent('qb-inventory:client:idcardanim', function(source)
	local src = source
    local lib = 'paper_1_rcm_alt1-8'
	local anim = 'player_one_dual-8'
	-- print("Animation")
	LoadAnimDict(lib)
	TaskPlayAnim(PlayerPedId(),lib,anim, 3.0, 3.0, 10000, 1, 0.15, 0, 0, 0)	
