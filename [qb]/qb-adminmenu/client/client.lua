...
local menu16 = MenuV:CreateMenu(false, Lang:t('menu.spawn_items'), menuLocation, 220, 20, 60, 'size-125', 'none', 'menuv', 'test16')

RegisterNetEvent('qb-admin:client:openMenu', function()
	TriggerServerEvent('qb-log:server:CreateLog', 'admin', 'Admin Menu Open', 'red', string.format('**%s** opened the admin Menu', GetPlayerName(PlayerId())))
...
menu2:AddButton({
    icon = '🎁',
    label = Lang:t('menu.spawn_items'),
    value = menu16,
    description = Lang:t('desc.spawn_items_desc')
})
...
menu2_admin_display_names:On('change', function()
	TriggerServerEvent('qb-log:server:CreateLog', 'admin', 'Admin toggleNames', 'red', string.format('**%s** used Admin toggleNames', GetPlayerName(PlayerId())))
    TriggerEvent('qb-admin:client:toggleNames')
end)

-- Toggle player blip display
menu2_admin_display_blips:On('change', function()
	TriggerServerEvent('qb-log:server:CreateLog', 'admin', 'Admin toggleBlips', 'red', string.format('**%s** used Admin toggleBlips', GetPlayerName(PlayerId())))
    TriggerEvent('qb-admin:client:toggleBlips')
end)

-- Toggle NoClip
menu2_admin_noclip:On('change', function(_, _, _)
	TriggerServerEvent('qb-log:server:CreateLog', 'admin', 'Admin NoClip', 'red', string.format('**%s** used Admin NoClip', GetPlayerName(PlayerId())))
    ToggleNoClip()
end)

-- Revive Self
menu2_admin_revive:On('select', function(_)
	TriggerServerEvent('qb-log:server:CreateLog', 'admin', 'Admin Revive', 'red', string.format('**%s** used Admin Revive', GetPlayerName(PlayerId())))
...
menu2_admin_invisible:On('change', function(_, _, _)
	TriggerServerEvent('qb-log:server:CreateLog', 'admin', 'Admin invisible toggled', 'red', string.format('**%s** used Admin invisible toggled', GetPlayerName(PlayerId())))
...
menu2_admin_god_mode:On('change', function(_, _, _)
    godmode = not godmode
	TriggerServerEvent('qb-log:server:CreateLog', 'admin', 'Admin godmode toggled', 'red', string.format('**%s** used Admin godmode toggled', GetPlayerName(PlayerId())))
    if godmode then
        while godmode do
            Wait(0)
...
for _, v in pairs(QBCore.Shared.Weapons) do
    menu15:AddButton({
        ...
        description = Lang:t('desc.spawn_weapons_desc'),
        select = function(_)
			TriggerServerEvent('qb-log:server:CreateLog', 'admin', 'Admin giveWeapon', 'red', string.format('**%s** used Admin giveWeapon', GetPlayerName(PlayerId())))
...
for _, v in pairs(QBCore.Shared.Items) do
    menu16:AddButton({
        ...
        description = Lang:t('desc.spawn_items_desc'),
        select = function(_)
			TriggerServerEvent('qb-log:server:CreateLog', 'admin', 'Admin giveItem', 'red', string.format('**%s** used Admin giveItem', GetPlayerName(PlayerId())))
            TriggerServerEvent('qb-admin:giveItem', v.name)
            QBCore.Functions.Notify(Lang:t('success.spawn_items'))
        end
    })
end
            ...
            menu11:AddButton({
                ...
                select = function(_)
                    if selectedgroup ~= 'Unknown' then
						TriggerServerEvent('qb-log:server:CreateLog', 'admin', 'Admin setPermissions', 'red', string.format('**%s** used Admin setPermissions', GetPlayerName(PlayerId())))
    ...
    menu10:AddButton({
        ...
        select = function(_)
            if kickreason ~= 'Unknown' then
				TriggerServerEvent('qb-log:server:CreateLog', 'admin', 'Admin kickplayer', 'red', string.format('**%s** used Admin kickplayer', GetPlayerName(PlayerId())))
...
local function OpenBanMenu(banplayer)
	TriggerServerEvent('qb-log:server:CreateLog', 'admin', 'Admin OpenBanMenu', 'red', string.format('**%s** used OpenBanMenu', GetPlayerName(PlayerId())))
    ...
    menu9:AddButton({
        ...
        select = function(_)
            if banreason ~= 'Unknown' and banlength ~= nil then
				TriggerServerEvent('qb-log:server:CreateLog', 'admin', 'Admin banplayer', 'red', string.format('**%s** used Admin banplayer', GetPlayerName(PlayerId())))
...
local function OpenPlayerMenus(player)
	TriggerServerEvent('qb-log:server:CreateLog', 'admin', 'Admin OpenPlayerMenus', 'red', string.format('**%s** used OpenPlayerMenus', GetPlayerName(PlayerId())))
...
player_management:On('select', function(_)
    menu4:ClearItems()
	TriggerServerEvent('qb-log:server:CreateLog', 'admin', 'Admin player_management', 'red', string.format('**%s** used player_management', GetPlayerName(PlayerId())))
...
local function OpenCarModelsMenu(category)
	TriggerServerEvent('qb-log:server:CreateLog', 'admin', 'Admin OpenCarModelsMenu', 'red', string.format('**%s** used OpenCarModelsMenu', GetPlayerName(PlayerId())))
    menu13:ClearItems()
    ...
    for k, v in pairs(category) do
        menu13:AddButton({
            ...
            select = function(_)
				TriggerServerEvent('qb-log:server:CreateLog', 'admin', 'Admin SpawnCar', 'red', string.format('**%s** used Admin SpawnCar', GetPlayerName(PlayerId())))
    ...
    for k, v in pairs(vehicles) do
        menu12:AddButton({
            ...
            select = function(btn)
				...
				TriggerServerEvent('qb-log:server:CreateLog', 'admin', 'Admin CarModelMenu', 'red', string.format('**%s** opened the admin CarModelMenu', GetPlayerName(PlayerId())))
            end
        })
    end
end)
...
menu5_vehicles_fix:On('Select', function(_)
	TriggerServerEvent('qb-log:server:CreateLog', 'admin', 'Admin fix', 'red', string.format('**%s** used Admin fix', GetPlayerName(PlayerId())))
    TriggerServerEvent('QBCore:CallCommand', 'fix', {})
end)

menu5_vehicles_buy:On('Select', function(_)
	TriggerServerEvent('qb-log:server:CreateLog', 'admin', 'Admin admincar', 'red', string.format('**%s** used Admin admincar', GetPlayerName(PlayerId())))
    TriggerServerEvent('QBCore:CallCommand', 'admincar', {})
end)

menu5_vehicles_remove:On('Select', function(_)
	TriggerServerEvent('qb-log:server:CreateLog', 'admin', 'Admin dv', 'red', string.format('**%s** used Admin dv', GetPlayerName(PlayerId())))
    TriggerServerEvent('QBCore:CallCommand', 'dv', {})
end)

menu5_vehicles_max_upgrades:On('Select', function(_)
	TriggerServerEvent('qb-log:server:CreateLog', 'admin', 'Admin maxmods', 'red', string.format('**%s** used Admin maxmods', GetPlayerName(PlayerId())))
...
RegisterNetEvent('qb-admin:client:ToggleCoords', function()
	TriggerServerEvent('qb-log:server:CreateLog', 'admin', 'Admin ToggleCoords', 'red', string.format('**%s** used Admin ToggleCoords', GetPlayerName(PlayerId())))
...
menu7_dev_noclip:On('change', function(_, _, _)
	TriggerServerEvent('qb-log:server:CreateLog', 'admin', 'Admin ToggleNoClip', 'red', string.format('**%s** opened the admin ToggleNoClip', GetPlayerName(PlayerId())))
    ToggleNoClip()
end)
