SetupLawyers = function(data) {
    ...
    if (data.length > 0) {
        ...
        $.each(data, function(i, lawyer) {
            ...
            if (lawyer.typejob == "mayor") {
                mayor.push(lawyer);
            }
            if (lawyer.typejob == "supreme") {
                lawyers.push(lawyer);
            }
            ...
            if (lawyer.typejob == "tuners") {
                mechanic.push(lawyer);
            }
            if (lawyer.typejob == "customs") {
                mechanic.push(lawyer);
            }
            if (lawyer.typejob == "mechj") {
                mechanic.push(lawyer);
            }
            if (lawyer.typejob == "pjsauto") {
                mechanic.push(lawyer);
            }
            if (lawyer.typejob == "taxi") {
                taxi.push(lawyer);
            }
            if (lawyer.typejob == "firefighter") {
                firefighter.push(lawyer);
            }
        ...
        $(".lawyers-list").append('<br><h1 style="font-size:1.641025641025641vh; padding:1.0256410256410255vh; color:#fff; margin-top:0; width:100%; display:block; background-color: rgb(255,182,193);">Ambulance (' + ambulance.length + ')</h1>');

        if (ambulance.length > 0) {
            $.each(ambulance, function(i, lawyer5) {
                var element = '<div class="lawyer-list" id="lawyerid5-' + i + '"> <div class="lawyer-list-firstletter" style="background-color: rgb(255,182,193);">' + (lawyer5.name).charAt(0).toUpperCase() + '</div> <div class="lawyer-list-fullname">' + lawyer5.name + '</div> <div class="lawyer-list-call"><i class="fas fa-phone"></i></div> </div>'
                $(".lawyers-list").append(element);
        ...
        $(".lawyers-list").append('<br><h1 style="font-size:1.641025641025641vh; padding:1.0256410256410255vh; color:#fff; margin-top:0; width:100%; display:block; background-color: rgb(120, 120, 120);">Reporter (' + reporter.length + ')</h1>');

        if (reporter.length > 0) {
            $.each(reporter, function(i, lawyer6) {
                var element = '<div class="lawyer-list" id="lawyerid6-' + i + '"> <div class="lawyer-list-firstletter" style="background-color: rgb(120, 120, 120);">' + (lawyer6.name).charAt(0).toUpperCase() + '</div> <div class="lawyer-list-fullname">' + lawyer6.name + '</div> <div class="lawyer-list-call"><i class="fas fa-phone"></i></div> </div>'
                $(".lawyers-list").append(element);
                $("#lawyerid6-" + i).data('LawyerData', lawyer6);
            });
        } else {
            var element = '<div class="lawyer-list"><div class="no-lawyers">There is no reporter available.</div></div>'
            $(".lawyers-list").append(element);
        }
		
        $(".lawyers-list").append('<br><h1 style="font-size:1.641025641025641vh; padding:1.0256410256410255vh; color:#fff; margin-top:0; width:100%; display:block; background-color: rgb(100, 40, 120);">Mayor (' + mayor.length + ')</h1>');

        if (mayor.length > 0) {
            $.each(mayor, function(i, lawyer7) {
                var element = '<div class="lawyer-list" id="lawyerid7-' + i + '"> <div class="lawyer-list-firstletter" style="background-color: rgb(100, 40, 120);">' + (lawyer7.name).charAt(0).toUpperCase() + '</div> <div class="lawyer-list-fullname">' + lawyer7.name + '</div> <div class="lawyer-list-call"><i class="fas fa-phone"></i></div> </div>'
                $(".lawyers-list").append(element);
                $("#lawyerid7-" + i).data('LawyerData', lawyer7);
            });
        } else {
            var element = '<div class="lawyer-list"><div class="no-lawyers">There is no mayor available.</div></div>'
            $(".lawyers-list").append(element);
        }
		
        $(".lawyers-list").append('<br><h1 style="font-size:1.641025641025641vh; padding:1.0256410256410255vh; color:#fff; margin-top:0; width:100%; display:block; background-color: rgb(255, 0, 0);">Firefighter (' + firefighter.length + ')</h1>');

        if (firefighter.length > 0) {
            $.each(firefighter, function(i, lawyer8) {
                var element = '<div class="lawyer-list" id="lawyerid8-' + i + '"> <div class="lawyer-list-firstletter" style="background-color: rgb(255, 0, 0);">' + (lawyer8.name).charAt(0).toUpperCase() + '</div> <div class="lawyer-list-fullname">' + lawyer8.name + '</div> <div class="lawyer-list-call"><i class="fas fa-phone"></i></div> </div>'
                $(".lawyers-list").append(element);
                $("#lawyerid8-" + i).data('LawyerData', lawyer8);
            });
        } else {
            var element = '<div class="lawyer-list"><div class="no-lawyers">There is no firefighter available.</div></div>'
            $(".lawyers-list").append(element);
        }
        ...
        var element = '<div class="lawyer-list"><div class="no-lawyers">There are no polices available.</div></div>'
        $(".lawyers-list").append(element);
        ...
        var element = '<div class="lawyer-list"><div class="no-lawyers">There are no reporter personnel a available.</div></div>'
        $(".lawyers-list").append(element);
		
        $(".lawyers-list").append('<br><h1 style="font-size:1.641025641025641vh; padding:1.0256410256410255vh; color:#fff; margin-top:0; width:100%; display:block; background-color: rgb(100, 40, 120);">Mayor (' + mayor.length + ')</h1>');

        var element = '<div class="lawyer-list"><div class="no-lawyers">There are no mayor personnel a available.</div></div>'
        $(".lawyers-list").append(element);
		
        $(".lawyers-list").append('<br><h1 style="font-size:1.641025641025641vh; padding:1.0256410256410255vh; color:#fff; margin-top:0; width:100%; display:block; background-color: rgb(255, 0, 0);">Firefighter (' + firefighter.length + ')</h1>');

        var element = '<div class="lawyer-list"><div class="no-lawyers">There are no firefighters available.</div></div>'
        $(".lawyers-list").append(element);
