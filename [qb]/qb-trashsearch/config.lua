...
Config.General = {
    ...
    DurationOfSearch = math.random(3000,9000), -- In miliseconds
    -- How long does before player can search again
    SearchCooldown = 5000, -- In miliseconds
...
Config.Reward = {
    ...
    -- Money
    Money = {
        Chance = 45, -- Chance to get money instead of an item in % (0-100)
        Min = 1,
        Max = 45
    },
    ...
    -- Items you can get
    ItemList = {
        "water_bottle", "metalscrap", "plastic", "copper", "glass", "rolling_paper", "milk", "hotsauce", "emptycowbucket", "apple_juice", "apple",
        "beklighter","beer","tosti"
    }
}
