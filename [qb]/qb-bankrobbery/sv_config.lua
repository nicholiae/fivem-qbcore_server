...
Config.BlackoutTimer = 15 -- The amount of minutes a blackout will take until all power comes back
...
Config.LockerRewardsPaleto = {
    ["tier1"] = {
        [1] = {item = "goldchain", minAmount = 5, maxAmount = 40},
    },
    ["tier2"] = {
        [1] = {item = "rolex", minAmount = 5, maxAmount = 20},
    },
    ["tier3"] = {
        [1] = {item = "goldbar", minAmount = 2, maxAmount = 10},
    },
}
