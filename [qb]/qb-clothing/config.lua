...
Config.Stores = {
    [1] = {shopType = 'clothing', coords = vector3(1693.32, 4823.48, 41.06), width = 6, length = 6},
    [2] = {shopType = 'clothing', coords = vector3(-712.215881, -155.352982, 37.4151268), width = 6, length = 6},
    [3] = {shopType = 'clothing', coords = vector3(-1192.94495, -772.688965, 17.3255997), width = 6, length = 6},
    [4] = {shopType = 'clothing', coords = vector3(425.236, -806.008, 28.491), width = 6, length = 6},
    [5] = {shopType = 'clothing', coords = vector3(-162.658, -303.397, 38.733), width = 6, length = 6},
    [6] = {shopType = 'clothing', coords = vector3(75.950, -1392.891, 28.376), width = 6, length = 6},
    [7] = {shopType = 'clothing', coords = vector3(-822.194, -1074.134, 10.328), width = 6, length = 6},
    [8] = {shopType = 'clothing', coords = vector3(-1450.711, -236.83, 48.809), width = 6, length = 6},
    [9] = {shopType = 'clothing', coords = vector3(4.254, 6512.813, 30.877), width = 6, length = 6},
    [10] = {shopType = 'clothing', coords = vector3(615.180, 2762.933, 41.088), width = 6, length = 6},
    [11] = {shopType = 'clothing', coords = vector3(1196.785, 2709.558, 37.222), width = 6, length = 6},
    [12] = {shopType = 'clothing', coords = vector3(-3171.453, 1043.857, 19.863), width = 6, length = 6},
    [13] = {shopType = 'clothing', coords = vector3(-1100.959, 2710.211, 18.107), width = 6, length = 6},
    [14] = {shopType = 'clothing', coords = vector3(-1207.65, -1456.88, 4.3784737586975), width = 6, length = 6},
    [15] = {shopType = 'clothing', coords = vector3(119.7, -223.03, 54.56), width = 6, length = 6},
    [16] = {shopType = 'barber', coords = vector3(-814.3, -183.8, 36.6), width = 6, length = 6},
    [17] = {shopType = 'surgeon', coords = vector3(4668.98, -5101.12, 14.6), width = 6, length = 6},
    ...
    [23] = {shopType = 'clothing', coords = vector3(420.93, -984.59, 21.56), width = 6, length = 6}
}

Config.OutfitChangers = {
    [1] = {shopType = 'outfit', coords = vector3(1697.41, 4829.25, 41.06), width = 3, length = 3},
    [2] = {shopType = 'outfit', coords = vector3(-703.83, -151.67, 36.42), width = 3, length = 3},
    [3] = {shopType = 'outfit', coords = vector3(-1187.19, -768.64, 16.33), width = 3, length = 3},
    [4] = {shopType = 'outfit', coords = vector3(416.36, -984.69, 21.56), width = 3, length = 3},
    [5] = {shopType = 'outfit', coords = vector3(-168.21, -298.7, 38.73), width = 3, length = 3},
    [6] = {shopType = 'outfit', coords = vector3(71.06, -1399.17, 28.38), width = 3, length = 3},
    [7] = {shopType = 'outfit', coords = vector3(-829.72, -1073.33, 10.33), width = 3, length = 3},
    [8] = {shopType = 'outfit', coords = vector3(-1447.51, -242.81, 48.82), width = 3, length = 3},
    [9] = {shopType = 'outfit', coords = vector3(12.28, 6513.63, 30.88), width = 3, length = 3},
    [10] = {shopType = 'outfit', coords = vector3(617.89, 2766.79, 41.09), width = 3, length = 3},
    [11] = {shopType = 'outfit', coords = vector3(1190.35, 2714.51, 37.22), width = 3, length = 3},
    [12] = {shopType = 'outfit', coords = vector3(-3175.64, 1041.84, 19.86), width = 3, length = 3},
    [13] = {shopType = 'outfit', coords = vector3(-1108.95, 2709.37, 18.11), width = 3, length = 3},
    [14] = {shopType = 'outfit', coords = vector3(-1203.79, -1454.53, 3.38), width = 3, length = 3},
    [15] = {shopType = 'outfit', coords = vector3(122.12, -219.8, 54.56), width = 3, length = 3},
    [16] = {shopType = 'outfit', coords = vector3(207.54, -1662.63, 29.8), width = 3, length = 3},
    [17] = {shopType = 'outfit', coords = vector3(1178.95, 2644.84, 37.8), width = 3, length = 3}
	
}

-- set isGang to true if the requiredJob is a gang
Config.ClothingRooms = {
    -- [1] = {requiredJob = 'firefighter', isGang = false, coords = vector3(207.54, -1662.63, 29.8), width = 6, length = 6, cameraLocation = vector4(206.07, -1661.17, 29.8, 50.59)},
    -- [2] = {requiredJob = 'ambulance', isGang = false, coords = vector3(342.47, -586.15, 43.32), width = 6, length = 6, cameraLocation = vector4(342.47, -586.15, 43.32, 342.56)},
    -- [3] = {requiredJob = 'police', isGang = false, coords = vector3(314.76, 671.78, 14.73), width = 6, length = 6, cameraLocation = vector4(317.62, 671.86, 14.73, 91.53)},
    -- [4] = {requiredJob = 'ambulance', isGang = false, coords = vector3(338.70, 659.61, 14.71), width = 6, length = 6, cameraLocation = vector4(339.27, 661.63, 14.71, 315.5)},
    -- [5] = {requiredJob = 'ambulance', isGang = false, coords = vector3(-1098.45, 1751.71, 23.35), width = 6, length = 6, cameraLocation = vector4(-1097.15, 1750.19, 23.35, 38.70)},
    -- [6] = {requiredJob = 'police', isGang = false, coords = vector3(-77.59, -129.17, 5.03), width = 6, length = 6, cameraLocation = vector4(-80.36, -130.76, 5.03, 300.44)},
    -- [7] = {requiredJob = "realestate", isGang = false, coords = vector3(-131.45, -633.74, 168.82), width = 6, length = 6, cameraLocation = vector4(-131.45, -633.74, 168.82,  2.18)}
}
        ...
        ['male'] = {
            ...
            [0] = {
                ...
                [1] = {
                    ...
                    outfitLabel = 'Geared',
                    outfitData = {
                        ['pants'] = {texture = 209, item = 1, defaultItem = 0, defaultTexture = 0}, -- Pants
                        ['arms'] = {item = 210, texture = 5, defaultItem = 0, defaultTexture = 0}, -- Arms
                        ['t-shirt'] = {item = 258, texture = 0, defaultItem = 0, defaultTexture = 0}, -- T Shirt
                        ['vest'] = {item = 15, texture = 0, defaultItem = 0, defaultTexture = 0}, -- Body Vest
                        ['torso2'] = {item = 410, texture = 1, defaultItem = 0, defaultTexture = 0}, -- Jacket
                        ['shoes'] = {item = 117, texture = 0, defaultItem = 0, defaultTexture = 0}, -- Shoes
                        ...
                        ['hat'] = {item = 213, texture = 2, defaultItem = 0, defaultTexture = 0}, -- Hat
                        ['glass'] = {item = 0, texture = 0, defaultItem = 0, defaultTexture = 0}, -- Glasses
                        ['mask'] = {item = 213, texture = 2, defaultItem = 0, defaultTexture = 0} -- Mask
                    }
                }
            },
		},
