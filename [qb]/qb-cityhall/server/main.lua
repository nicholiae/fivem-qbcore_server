...
RegisterNetEvent('qb-cityhall:server:requestId', function(item, hall)
    ...
    elseif item == 'weaponlicense' then
        ...
        info.lastname = Player.PlayerData.charinfo.lastname
        info.birthdate = Player.PlayerData.charinfo.birthdate
    elseif item == 'xscript' or 'mscript' or 'ascript' or 'oscript' or 'iscript' then
		info.citizenid = Player.PlayerData.citizenid
		info.firstname = Player.PlayerData.charinfo.firstname
		info.lastname = Player.PlayerData.charinfo.lastname
		info.birthdate = Player.PlayerData.charinfo.birthdate
...
RegisterNetEvent('qb-cityhall:server:ApplyJob', function(job, cityhallCoords)
    ...
    TriggerEvent('qb-log:server:CreateLog', 'qbjobs', 'City Hall Assigned Job', 'green', 'Player:'..tostring(Player.PlayerData.name)..' JobChangedTo:'..tostring(JobInfo.label))
