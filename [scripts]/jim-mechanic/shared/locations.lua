...
Config.Locations[#Config.Locations+1] = { --[[ LS CUSTOMS IN CITY ]]--
	...
	stash = {
		{ coords = vec4(-0.0, -0.0, 0.0, 0.0), w = 0.0, d = 0.0, }, -- corner shelf fuckall doesnt work
	},
	store = {
		{ vec4(-0.0, -0.0, 0.0, 0.0), w = 0.0, d = 0.0, }, --not used
	},
	crafting = {
		{ coords = vec4(-0.0, -0.0, 0.0, 0.0), w = 0.0, d = 0.0, }, -- ontop of mini fridge
	},
	clockin = {
		{ coords = vec4(125.58, -3013.33, 7.04, 190.33), prop = false }, -- same as payments
	},
	manualRepair = {
		{ coords = vec4(124.66, -3050.2, 7.04, 358.88), prop = true, }, 
	},
	garage = {
	...
	payments = {
		...
		{ coords = vec4(-0.0, -0.0, 0.0, 0.0), prop = false, }, --shop ontop of workbench
	},
	Restrictions = {
	...
	blip = {
		coords = vec3(124.62, -3050.15, 7.04),
		label = "Repair Bench",
		color = 1,
		sprite = 446,
		disp = 6,
...
Config.Locations[#Config.Locations+1] = { --[[ PDM ]]--
	Enabled = true,
	job = "",
	zones = {
		vec2(-36.17, -1091.58),
	...
	clockin = {
		{ coords = vec4(-0.0, -0.0, 0.0, 0.0), prop = false }, -- same as payments
	},
	manualRepair = {
		{ coords = vec4(-26.94, -1089.94, 26.42, 56.52), prop = true, }, 
	},
	garage = {
		spawn = vec4(-0.0, -0.0, 0.0, 0.0),
		out = vec4(-0.0, -0.0, 0.0, 0.0),
	...
	blip = {
		coords = vec3(-26.94, -1089.94, 26.42),
		label = "Repair Bench",
		color = 1,
		sprite = 446,
		disp = 6,
...
Config.Locations[#Config.Locations+1] = { --[[ LS CUSTOMS IN CITY ]]--
	...
	autoClock = { enter = false, exit = false, },
	stash = {
		{ coords = vec4(-342.98, -157.17, 44.59, 174.72), w = 4.0, d = 3.0, }, -- corner shelf fuckall doesnt work
	},
	store = {
		{ coords = vec4(10, 10, 10, 10), w = 0.0, d = 0.0, }, --not used
	},
	crafting = {
		{ coords = vec4(-344.96, -156.29, 45.52, 301.07), w = 3.2, d = 1.0, }, -- ontop of mini fridge
	},
	clockin = {
		{ coords = vec4(-344.99, -156.23, 45.52, 306.05), prop = true }, -- same as payments
	},
	manualRepair = {
		{ coords = vec4(-388.42, -101.82, 38.77, 207.99), prop = true, }, 
	},
	garage = {
		spawn = vec4(-340.01, -161.1, 39.01, 293.25),
		out = vec4(-341.67, -157.52, 39.01, 111.41),
		list = { "towtruck", "panto", "slamtruck", "cheburek", "utillitruck3" },
		prop = true
	},
	payments = {
		img = "https://static.wikia.nocookie.net/gtawiki/images/f/f2/GTAV-LSCustoms-Logo.png",
		{ coords = vec4(-319.66, -138.91, 39.5, 250.67), prop = true, }, --shop ontop of workbench
	},
	Restrictions = {
		Vehicle = { "Compacts", "Sedans", "SUVs", "Coupes", "Muscle", "Sports Classics", "Sports", "Super", "Motorcycles", "Off-road", "Industrial", "Utility", "Vans", "Cycles", "Service", "Emergency", "Commercial", },
		Allow = { "tools", "cosmetics", "repairs", "nos", "perform" },
	...
	blip = {
		coords = vec3(-355.62, -120.52, 38.72),
		label = "Repair Bench",
		color = 1,
		sprite = 446,
		disp = 6,
...
Config.Locations[#Config.Locations+1] = { --[[ J mechj ]]--
	Enabled = true,
	job = "mechj",
	zones = {
		vec2(-295.91, -1409.82),
	...
	store = {
		{ coords = vec4(-0.0, -0.0, 0.0, 0.0), w = 0.0, d = 0.0, }, --not used
	},
	crafting = {
		{ coords = vec4(-0.0, -0.0, 0.0, 0.0), w = 0.0, d = 0.0, }, -- ontop of mini fridge
	},
	clockin = {
		{ coords = vec4(-343.12, -1332.99, 32.35, 239.21), prop = true }, -- same as payments
	},
	manualRepair = {
		{ coords = vec4(-318.19, -1334.47, 31.63, 271.29), prop = true, }, 
	},
	garage = {
		spawn = vec4(-340.01, -161.1, 39.01, 293.25),
		out = vec4(-341.67, -157.52, 39.01, 111.41),
	...
	payments = {
		img = "https://static.wikia.nocookie.net/gtawiki/images/f/f2/GTAV-LSCustoms-Logo.png",
		{ coords = vec4(-329.22, -1335.08, 32.35, 178.58), prop = true, }, --shop ontop of workbench
	},
	Restrictions = {
		Vehicle = { "Compacts", "Sedans", "SUVs", "Coupes", "Muscle", "Sports Classics", "Sports", "Super", "Motorcycles", "Off-road", "Industrial", "Utility", "Vans", "Cycles", "Service", "Emergency", "Commercial", },
		Allow = { "tools", "cosmetics", "repairs", "nos", "perform" },
	...
	blip = {
		coords = vec3(-335.31, -1353.64, 51.35),
		label = "Repair Bench",
		color = 1,
		sprite = 446,
		disp = 6,
...
Config.Locations[#Config.Locations+1] = { --[[ Bikes LostMC Gang ]]--
	Enabled = true,
	job = "bikes",
	zones = {
		vec2(976.12, -2552.7),
		vec2(981.79, -2477.92),
		vec2(1052.75, -2486.14),
		vec2(1046.59, -2560.1)
	},
	autoClock = { enter = false, exit = false, },
	stash = {
	...
	clockin = {
		{ coords = vec4(0, 0, 0, 0), prop = false }, -- same as payments
	},
	manualRepair = {
		{ coords = vec4(983.79, -2491.17, 28.3, 264.66), prop = true, },
	},
	garage = {
		spawn = vec4(-0.0, -0.0, 0.0, 0.0),
		out = vec4(-0.0, -0.0, 0.0, 0.0),
	...
	blip = {
		coords = vec3(-238.31, 6215.01, 31.94),
		label = "Repair Bench",
		color = 1,
		sprite = 446,
		disp = 6,
...
Config.Locations[#Config.Locations+1] = { --[[ Bikes Paleto ]]--
	Enabled = true,
	job = "bikes",
	zones = {
		vec2(-262.35, 6207.86),
	...
	clockin = {
		{ coords = vec4(-238.31, 6215.01, 31.94, 70.81), prop = false }, -- same as payments
	},
	manualRepair = {
		{ coords = vec4(-223.62, 6218.48, 31.61, 315.11), prop = true, },
	},
	garage = {
		spawn = vec4(-0.0, -0.0, 0.0, 0.0),
		out = vec4(-0.0, -0.0, 0.0, 0.0),
...
Config.Locations[#Config.Locations+1] = { --[[ pjsauto sandy ]]--
	Enabled = true,
	job = "tow",
	zones = {
		vec2(1191.92, 2656.92),
		vec2(1193.61, 2631.75),
		vec2(1167.24, 2630.87),
		vec2(1166.69, 2661.47)
	},
	autoClock = { enter = false, exit = false, },
	stash = {
		{ coords = vec4(-0.0, -0.0, 0.0, 0.0), w = 0.0, d = 0.0, }, -- corner shelf fuckall doesnt work
	...
	clockin = {
		{ coords = vec4(1188.84, 2640.47, 38.4, 268.82), prop = false }, -- same as payments
	},
	manualRepair = {
		{ coords = vec4(1186.15, 2649.81, 37.85, 95.75), prop = true, },
	},
	garage = {
		spawn = vec4(-0.0, -0.0, 0.0, 0.0),
		out = vec4(-0.0, -0.0, 0.0, 0.0),
	...
	blip = {
		coords = vec3(1186.15, 2649.81, 37.85),
		label = "Repair Bench",
		color = 1,
		sprite = 446,
		disp = 6,
...
Config.Locations[#Config.Locations+1] = { --[[ Airial Vehicles Repair ]]--
	Enabled = true,
	job = "mechanic2",
	zones = {
		vec2(-1189.61, -3361.08),
		vec2(-1200.94, -3381.39),
		vec2(-1217.92, -3372.16),
		vec2(-1207.08, -3353.06),
	},
	autoClock = { enter = false, exit = false, },
	stash = {
		{ coords = vec4(-0.0, -0.0, 0.0, 0.0), w = 3.6, d = 0.6 },
	},
	store = {
		{ coords = vec4(-0.0, -0.0, 0.0, 0.0), w = 1.6, d = 0.6 },
	},
	crafting = {
		{ coords = vec4(-0.0, -0.0, 0.0, 0.0), w = 4.0, d = 0.6 },
	},
	clockin = {
		{ coords = vec4(-0.0, -0.0, 0.0, 0.0), prop = true, },
	},
	manualRepair = {
		{ coords = vec4(-1197.73, -3370.28, 13.95, 65.14), prop = true, },
	},
	...
	Restrictions = { -- Remove what you DON'T what the location to be able to edit
		Vehicle = { "Compacts", "Sedans", "SUVs", "Coupes", "Muscle", "Sports Classics", "Sports", "Super", "Motorcycles", "Off-road", "Industrial", "Utility", "Helicopters", "Planes", "Vans", "Cycles", "Service", "Emergency", "Commercial", },
		Allow = { "repairs" },
	},
	blip = {
		coords = vec3(-1197.73, -3370.28, 13.95),
		label = "Repair Bench",
		color = 1,
		sprite = 446,
		disp = 6,
...
Config.Locations[#Config.Locations+1] = { --[[ Airial Vehicles Repair ]]--
	...
	zones = {
		vec2(-2198.7, 1121.32),
		vec2(-2210.02, 1121.67),
		vec2(-2209.38, 1130.4),
		vec2(-2198.42, 1130.41),
	},
	autoClock = { enter = false, exit = false, },
	stash = {
		{ coords = vec4(-0.0, -0.0, 0.0, 0.0), w = 3.6, d = 0.6 },
	...
	manualRepair = {
		{ coords = vec4(-2202.58, 1127.62, 29.77, 174.84), prop = true, },
	},
	garage = { -- requires jim-jobgarge
		spawn = vec4(-0.0, -0.0, 0.0, 0.0),
		out = vec4(-0.0, -0.0, 0.0, 0.0),
		list = { "towtruck", "panto", "slamtruck", "cheburek", "utillitruck3" },
		prop = false, -- spawn a prop (if there isn't alreaady one available in the current MLO at the location)
	},
	payments = { -- requires jim-payments
		{ coords = vec4(-0.0, -0.0, 0.0, 0.0), prop = false, },
		img = "https://static.wikia.nocookie.net/gtawiki/images/b/be/BennysOriginalMotorWorks-GTAO-Logo.png",
	...
	blip = {
		coords = vec3(-2202.58, 1127.62, 29.77),
		label = "Repair Bench",
		color = 1,
		sprite = 446,
		disp = 6,
...
Config.Locations[#Config.Locations+1] = { --[[ BENNYS NEXT TO PDM ]]--
	...
	manualRepair = {
		{ coords = vec4(-208.54, -1318.52, 30.89, 270.0), prop = true, },
	},
	garage = { -- requires jim-jobgarge
	...
	blip = {
		coords = vec3(-208.54, -1318.52, 30.89),
		label = "Repair Bench",
		color = 1,
		sprite = 446,
		disp = 6,
