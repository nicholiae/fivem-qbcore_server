...
Config = {
    ...
    ['Reward'] = 6000,--Reward Per Bundle Of Cash 
    ['PrintedCash'] = 25,--Amount of bundles per trolley 
    ['RequiredCops'] = 4, -- cops required to lockpick the door / grab cash
...
Config.BlipMarkerLoc = vector3(136.04, -761.81, 45.75)
