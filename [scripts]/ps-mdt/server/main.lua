...
local MugShotWebhook = 'https://discord.com/api/webhooks/1272350052001644585/ckpaCogXn0lr5A-N4_z-QDfMQhb-FxY0rYAxur5EUfeste_fX2wmPXY2Kjg82eesd78J'

-- Clock-in notifications for duty. Add a Discord webhook.
-- Command /mdtleaderboard, will display top players per clock-in hours.
local ClockinWebhook = 'https://discord.com/api/webhooks/1272349856882491402/kcH5bpQ66ED_aD_sS1uLyxAjG0qxLK1nSo28VaK3VmXQ6aG189Tr7x4iJyd9HFr-W5Td'

-- Incident and Incident editting. Add a Discord webhook.
-- Incident Author, Title, and Report will display in webhook post.
local IncidentWebhook = 'https://discord.com/api/webhooks/1272349985974780007/zIO_6X8EZBBpUSU3PjUH2zNMJi7eUrWJ4MdA0YTRt021B6V2TMl0V4vP0k7RmRK6M358'
--------------------------------
...
QBCore.Functions.CreateCallback('mdt:server:GetProfileData', function(source, cb, sentId)
	...
	if Config.PoliceJobs[JobName] or Config.DojJobs[JobName] or Config.AmbulanceJobs[JobName] then
