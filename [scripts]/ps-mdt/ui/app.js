...
$(document).ready(() => {
  ...
  $(".profile-items").on("click", ".profile-item", async function () {
    ...
    if (licenses.length > 0 && (PoliceJobs[playerJob] !== undefined || DojJobs[playerJob] !== undefined || AmbulanceJobs[playerJob] !== undefined)) {
      licencesHTML = '';
...
function searchProfilesResults(result) {
  ...
  result.forEach((value) => {
    ...
    if (licArr.length > 0 && (PoliceJobs[playerJob] !== undefined || DojJobs[playerJob] !== undefined || AmbulanceJobs[playerJob] !== undefined)) {
