...
RegisterNetEvent('luckywheel:give', function(source, price)
	...
	elseif price.type == 'blackmarket' then
		TriggerClientEvent("chCasinoWall:bigWin", source)
		TriggerClientEvent('QBCore:Notify', source, "Congratulations! You won the BlackMarket Location!", 'success')
		TriggerClientEvent('QB-Shops:Client:setPoint', source)
	end
