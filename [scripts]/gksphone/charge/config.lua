...
NormalCharging = 2  -- Adjust this part how much you want to fill in how many seconds
NormalChargingPropName = "gks_charge_normal"
NormalChargePay = 2  -- pay * percent

FastChargingFillingTime = 2 -- seconds
FastCharging = 3  -- Adjust this part how much you want to fill in how many seconds
FastChargingPropName = "gks_charge_fast"
FastChargePay = 6  -- pay * percent
