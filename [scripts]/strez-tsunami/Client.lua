...
RegisterNetEvent('strez:client:TsunamiShowcase', function(text)
    ...
    if Config.Showcase == 'qb' then
        TriggerEvent('QBCore:Notify', 'Stage 4/1min Restart: Will get a final email warning & air siren alert to warn people get to high ground for safety & BLACKOUT to the city', 'success', 15000)
    elseif Config.Showcase == 'ox' then
...
RegisterNetEvent('strez:raisewater', function()
    CreateThread(function()
        ...
        local maxFloodHeight = 360 -- Change this value to set the maximum flood height
		
        -- local increaseRate = math.random(1.0,3.0) -- Change this value to increase/decrease the rate at which the water height changes
        local increaseRate = 3 -- Change this value to increase/decrease the rate at which the water height changes

        -- local threadWait = math.random(3000,10000) -- Change this value to increase/decrease the time it takes to reach maxFloodHeight.
        local threadWait = 3000 -- Change this value to increase/decrease the time it takes to reach maxFloodHeight.

		QBCore.Functions.TriggerCallback('tsunami:server:getValues', function(maxFloodHeight,increaseRate,threadWait)
		
			maxFloodHeight = maxFloodHeight
