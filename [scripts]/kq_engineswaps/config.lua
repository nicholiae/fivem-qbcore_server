...
-- Your shared banking system. 'qb-banking', 'qb-management' or 'qb-bossmenu'
Config.SharedBankingSystem = 'qb-banking'
...
Config.ShipmentDurationMutator = 0
...
Config.Workshops = {
	{
        location = { x = 694.53, y = -773.63, z = 24.49, h = 270.91},
        ...
        sharedAccount = 'customs',

        permissions = {
            swapJobGrade = 1,
            purchaseEngineJobGrade = 2,
        },

        laptop = {
            prop = {
                x = 696.11, y = -770.96, z = 24.45, h = 128.08, model = 'p_laptop_02_s'
            }
        },
        lift = {
            prop = {
                x = 694.27, y = -760.22, z = 24.44, h = 186.66, model = 'prop_engine_hoist'
            },	
            clearArea = false,
            clearRadius = 5.0,
        ...
        engineDropoff = {
            x = 680.12, y = -766.97, z = 24.44, h = 116.14,
            clearArea = false,
            clearRadius = 3.0,
        },
        newEngine = { 
            x = 697.92, y = -752.4, z = 24.44, h = 279.98,
            clearArea = false,
            clearRadius = 3.0,
        },
    }
...
Config.PowerMultiplier = 3
Config.MaxVMultiplier = 1.5
