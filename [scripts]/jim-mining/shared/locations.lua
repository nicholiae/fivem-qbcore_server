Config.Locations = {
    ...
    ["Panning"] = {
        ...
        positions = {
            ["Vineyard"] = {
                ...
                Positions = {
                    { coords = vector4(-1396.3, 2004.59, 61.6, 82.0), w = 22.1, d = 4.0 },
                    { coords = vector4(-1410.08, 2006.08, 59.2, 89.0), w = 6.3, d = 4.2 },
                    { coords = vector4(-1418.62, 2006.05, 59.41, 89.0), w = 10.9, d = 6.0 },
                }
            },
            ["Tongva"] = {
                Enable = true,
                ...
                Positions = {
                    { coords = vector4(-1550.06, 1445.13, 116.37, 139.0), w = 10.9, d = 6.0 },
                    { coords = vector4(-1562.88, 1434.03, 117.19, 129.0), w = 24.3, d = 6.0 },
                }
            },
            ["Wilderness"] = {
                Enable = true,
                ...
                Positions = {
                    { coords = vector4(-870.24, 4424.14, 15.09, 129.0), w = 25.1, d = 19.8 },
                }
            },
        },
    },
	['JewelBuyer'] = { -- The Location of the jewel buyer, I left this as Vangelico, others will proabably change to pawn shops
        Enable = true,
        positions = {
            { name = "Jewel Buyer", coords = vec4(-622.61, -229.61, 38.06, 296.9), sprite = 527, col = 617, blipTrue = false, model = `S_M_M_HighSec_03`, scenario = "WORLD_HUMAN_CLIPBOARD", },
        },
    },
    ["Smelting"] = {
