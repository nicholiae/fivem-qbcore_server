local webhook <const> = "https://discord.com/api/webhooks/1262554312345911417/pGkOVPr9mXlgFa_4P1XOuZkZlkOWPpeQvrm89UnGxhSPvelevPCoaykPPl35RUvXigKt" -- do not share your webhook with others
local mentionStaffRoleId <const> = 1261447681457524736 -- will only mention on possible cheating attempt, set to 'nil' for no mentions 
