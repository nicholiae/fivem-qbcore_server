...
AddEventHandler("np-paintball:joinWest", function()
	local west = vector3(5431.34, 6082.92, 590.01)
	Wait(1000)
	inArena = true
	inStadium = true
	TriggerEvent("np-paintball:startDeadCheck", inArena)
	SetEntityCoords(PlayerPedId(), west.x, west.y, west.z+1)
	Wait(1000)
...
AddEventHandler("np-paintball:joinEast", function()
	local east = vector3(5570.25, 6084.38, 590.01)
	Wait(1000)
	inArena = true
	inStadium = true
	TriggerEvent("np-paintball:startDeadCheck", inArena)
	SetEntityCoords(PlayerPedId(), east.x, east.y, east.z+1)
	Wait(1000)		
