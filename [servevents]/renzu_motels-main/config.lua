...
config.motels = {
	...
	[2] = { -- BirdieMotel
		...
		Mlo = true, -- if MLO you need to configure each doors coordinates,stash etc. if false resource will use shells
		shell = '', -- shell type, configure only if using Mlo = true
		label = 'Birdie Motel',
		rental_period = 'day',-- hour, day, month
		payment = 'bank', -- money, bank
		rate = 3000, -- cost per period
		motel = 'birdies',
		door = `v_ilev_fib_door1`, -- door hash for MLO type
		businessprice = 10000000,
		rentcoord = vec3(-2031.33, -355.03, 25.98),
		coord = vec3(-2025.13, -350.98, 25.98), -- center of the motel location
		radius = 50.0, -- radius of motel location
		maxoccupants = 1, -- maximum renters per room
		uniquestash = true, -- if true. each players has unique stash ID (non sharable and non stealable). if false stash is shared to all Occupants if maxoccupans is > 1
		doors = { -- doors and other function of each rooms
			[1] = {
				door = vec3(-2025.34, -360.04, 29.29),
				stash = vec3(-2027.97, -359.81, 29.04),
				wardrobe = vec3(-2031.11, -359.36, 29.04),
				fridge = vec3(-2032.2, -360.92, 29.04),
				-- luckyme = vec3(0.0,0.0,0.0) -- extra shit
			},
			[2] = {
				door = vec3(-2016.49, -351.88, 29.33),
				stash = vec3(-2011.01, -355.86, 29.09),
				wardrobe = vec3(-2015.02, -354.67, 29.04),
				fridge = vec3(-2016.66, -353.59, 29.04),
				-- luckyme = vec3(0.0,0.0,0.0) -- extra shit
			},
			[3] = {
				door = vec3(-2018.91, -350.92, 29.02),
				stash = vec3(-2019.25, -349.21, 29.04),
				wardrobe = vec3(-2021.02, -345.08, 29.04),
				fridge = vec3(-2020.31, -348.45, 29.04),
				-- luckyme = vec3(0.0,0.0,0.0) -- extra shit
			},
			[4] = {
				door = vec3(-2024.6, -363.35, 29.36),
				stash = vec3(-2020.02, -363.11, 29.04),
				wardrobe = vec3(-2024.89, -365.82, 29.04),
				fridge = vec3(-2019.19, -360.43, 29.04),
				-- luckyme = vec3(0.0,0.0,0.0) -- extra shit
			},
			[5] = {
				door = vec3(-2030.09, -363.47, 29.02),
				stash = vec3(-2040.81, -365.29, 29.04),
				wardrobe = vec3(-2038.21, -364.72, 29.04),
				fridge = vec3(-2038.96, -369.64, 29.13),
				-- luckyme = vec3(0.0,0.0,0.0) -- extra shit
			},
		},
	}
